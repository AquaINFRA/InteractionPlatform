import { Box, chakra, CheckboxProps, useCheckbox } from "@open-pioneer/chakra-integration";
...
const CustomCheckbox = (props: CheckboxProps & FacetCheckboxProps) => {
